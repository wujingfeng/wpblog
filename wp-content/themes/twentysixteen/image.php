			...
			?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<nav id="image-navigation" class="navigation image-navigation">
						<div class="nav-links">
							<div class="nav-previous" style="float: left;"><?php previous_image_link( false, __( 'Previous Image', 'twentysixteen' ) ); ?></div>
							<div class="nav-next" style="float: right;"><?php next_image_link( false, __( 'Next Image', 'twentysixteen' ) ); ?></div>
						</div><!-- .nav-links -->

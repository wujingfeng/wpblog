...
{
//    $addnum = rand(1,3);  //每个访客增加的访问数 1-3 的随机数
    $addnum = 1;
    session_start();
    $date = date('ymd', time());
...
function wb_echo_site_count()
{
    ...
    $date = date('ymd', time());
    echo '<div style="width:100%;padding: auto;color:#696969;text-align: center">
            <p style="margin: 0 0 1em;line-height: 1.2em">总访问量：
                <span style="color:red">' . absint($sitecount['all']) . '</span> 
                &nbsp;&nbsp; 今日访问量：
                <span style="color:red">' . absint($sitecount['today']) . '</span>
                &nbsp;&nbsp; 您的IP地址为：
                <span style="color:red">' . $_SERVER['REMOTE_ADDR'] . '</span>
            </p>
            <p style="margin: 0 0 1em;line-height: 1.2em"><span id="sitetime"></span></p>
            <script language="javascript">
                function siteTime(){
                    ...
                    var t1 =Date.UTC(2019,5,19,00,00,00);//北京时间2016-12-1 00:00:00
                    ...
                    if(diffYears<=0){
                        document.getElementById("sitetime").innerHTML="欢迎来到本站,本站已运行"+diffDays+" 天 "+diffHours+" 小时 "+diffMinutes+" 分钟 "+diffSeconds+" 秒"; 
                    } else {
                        document.getElementById("sitetime").innerHTML="欢迎来到本站,本站已运行"+diffYears+" 年 "+diffDays+" 天 "+diffHours+" 小时 "+diffMinutes+" 分钟 "+diffSeconds+" 秒"; 
                    }

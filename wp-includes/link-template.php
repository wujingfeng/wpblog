...
function get_the_post_navigation( $args = array() ) {
	...
	$previous = get_previous_post_link(
		'<div class="nav-previous" style="float: left;">%link</div>',
		$args['prev_text'],
		$args['in_same_term'],
		$args['excluded_terms'],
		$args['taxonomy']
	...
	$next = get_next_post_link(
		'<div class="nav-next" style="float: right;">%link</div>',
		$args['next_text'],
		$args['in_same_term'],
		$args['excluded_terms'],
		$args['taxonomy']
...
function get_the_posts_navigation( $args = array() ) {
	...
	if ( $GLOBALS['wp_query']->max_num_pages > 1 ) {
		...
		if ( $prev_link ) {
			$navigation .= '<div class="nav-previous" style="float: left;">' . $prev_link . '</div>';
		}

		if ( $next_link ) {
			$navigation .= '<div class="nav-next" style="float: right;">' . $next_link . '</div>';
		}
